...
function onCountdownStarted()
	textFont = 'five-nights-at-freddys.ttf'
	lyricSize = 54
end

--edit this to change the text font
function onEvent(name, value1, value2)
    if name == 'Lyrics_kusydf' then
		if value1 == '' then
		...
		if value2 == '' then
			...
			makeLuaSprite('iconInstance'..lyricIcon, 'lyrics/'..value2, screenWidth/2-500-iconOffsetX, 500+lyricOffsetY);
			setObjectCamera('iconInstance'..lyricIcon, 'camHUD')
			scaleObject ('iconInstance'..lyricIcon, 1.2, 1.2)
